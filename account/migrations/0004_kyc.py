# Generated by Django 3.2.7 on 2023-09-23 14:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('account', '0003_rename_red_code_account_ref_code'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_type', models.CharField(choices=[('national_id_card', 'National ID Card'), ('drivers_licence', "Driver's Licence"), ('international_passport', 'International Passport')], max_length=140)),
